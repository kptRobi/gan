...
# from main.utils.utils import setup_gpu, delete_old_images, normalize_image
#
# print("STARTING MAIN")
#
# # setup
...
#
#     hist = gan_model.fit(data_set, epochs=config.NUMBER_OF_EPOCHS, callbacks=[ModelMonitor(), SaveWeights()])
# else:
